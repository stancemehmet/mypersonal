      ...
      <>
        ...
        >
          <Popover.Panel className="p-4 w-full flex flex-col gap-1.5">
            <a
              href="https://www.instagram.com/mehmetccetiin/"
              className="text-[#607B96] hover:text-white inline-flex items-center gap-2.5 transition-colors"
              target="_blank"
              rel="noreferrer"
            >
              <FiInstagram />
              <span>mehmetccetiin</span>
            </a>
            <a
              href="https://steamcommunity.com/id/jstaNce/"
              className="text-[#607B96] hover:text-white inline-flex items-center gap-2.5 transition-colors"
              target="_blank"
              rel="noreferrer"
            >
            ...
            >
              <MdCall />
              <span>Only instagram and mail</span>
            </a>
            <a
            ...
            >
              <GrLinkedinOption />
              <span>Mehmet Çetin</span>
            </a>
            <a
              href="mehmetcetin.eng@outlook.com"
              className="text-[#607B96] hover:text-white inline-flex items-center gap-2.5 transition-colors"
            >
              <MdEmail />
              <span>mehmetcetin.eng@outlook.com</span>
            </a>
          </Popover.Panel>
        </Transition>
      </>
